...
/* @var $searchModel app\models\AccountViewSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Account Views';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="account-view-index">
